...
define('URL', 'http://localhost:81/Lewinsky_MA/'); //localhost
 ...
 * database host, usually it's "127.0.0.1" or "192.168.0.100:81", some servers also need port info, like "127.0.0.1:8080"
...
define("EMAIL_PASSWORD_RESET_FROM_EMAIL", "no-reply@marabele.com");
define("EMAIL_PASSWORD_RESET_FROM_NAME", "Marabele");
define("EMAIL_PASSWORD_RESET_SUBJECT", "Password reset for Marabele Project Manager");
define("EMAIL_PASSWORD_RESET_CONTENT", "Please click on this link to reset your password: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "no-reply@marabele.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Marabele");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Marabele Project Manager");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: ");
...
define("FEEDBACK_CONTACT_ADMIN_SUCCESSFUL", "Your message was sent to the support team, they are busy reading your e-mail right now. Check your e-mail for a response.");
define("FEEDBACK_CONTACT_ADMIN_UNSUCCESSFUL", "Eish! It seems like there was a problem in contacting the support team. E-mail this address as an alternative 'support@marabele.co.za'");