<div class="container" >       
	<div class="row">
		<br/>
		<h2><?php //echo $this->patient_id; ?>Patient: <?php echo $this->patient_details[0]->name." ".$this->patient_details[0]->surname; ?></h2>
		<div id="feedback">
		</div>
	</div>	
	<div class="row info-block">
		...
		<form action="<?php echo URL; ?>index/patient_referral/" method="post" class="postLink" scoped style="margin-left: 15px;"> 					    
			<input type="hidden" name="patient_id" value="<?php echo $this->patient_details[0]->user_id; ?>" > 					    
			<button type="submit" class="btn btn-default btn-sm">Patient Referral</button> 					
		</form>	
		<form action="<?php echo URL; ?>index/patient_prescrption/" method="post" class="postLink" scoped style="margin-left: 15px;"> 					    
			<input type="hidden" name="patient_id" value="<?php echo $this->patient_details[0]->user_id; ?>" > 					    
			<button type="submit" class="btn btn-default btn-sm">Patient Prescriptions</button> 					
		</form>							
	</div>
<style>
.info-block > div{
	...
	<div class="row" >	
		<div role="tabpanel" class=".col-xs-12 .col-sm-6 .col-md-8">
		  ...
		  <ul class="nav nav-tabs" role="tablist">
		  	<li role="presentation" ><a href="#PatientIod" aria-controls="PatientIod" role="tab" data-toggle="tab">Patient IOD</a></li>
		  ...
		  <div class="tab-content .col-xs-12 .col-sm-6 .col-md-8">
		    ...
		    <div role="tabpanel" class="tab-pane fade active" id="Transactions">
		    	<div class="row">
			    	...
			    	<div class="btn-group">
						<button class="btn btn-default btn-sm" type="button" data-toggle="modal" data-target="#createTransaction">New Transaction</button>
						<button class="btn btn-default btn-sm" type="button" data-toggle="modal" data-target="#createInvoice">Invoice</button>
				...
				<table class="table table-hover">
					<thead><tr><th>#</th><th>Code</th><th>Date</th><th>Amount</th><th>Vat</th><th>Cost Incl Vat</th><th>Mod1</th><th>Diagnosis</th><th>Description</th><th></th></tr></thead>
					<tbody>
					<?php $i = 0;
					foreach ($this->transactions as $key => $row) { $i++; ?>						
						<tr>
							...
							<td><?php echo $row->cost_incl_vat; ?></td>
							<td><?php echo $row->mod1; ?></td>
							<td><?php echo $row->diagnosis; ?>
		    ...
		    <?php //print_r($this->patient_details); ?>
							...
							<form class="form-horizontal" id="frmEditAidHolder" role="form" action="<?php echo URL; ?>generic/genericUpdate" method="post" enctype="multipart/form-data"  >
								<div class="modal-body">
									...
									<div class="form-group">
										...
										<div class="col-xs-10">
											<input type="text" name="id_number" placeholder="ID number" class="form-control" value="<?php echo $this->patient_details[0]->id_number; ?>" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-xs-2 control-label" for="dob">Date of birth</label>
										<div class="col-xs-10">
											<input type="date" name="dob" class="form-control" value="<?php echo $this->patient_details[0]->dob; ?>" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-xs-10">
											<select name="gender" class="form-control" required >
												<option><?php echo $this->patient_details[0]->gender; ?></option>
									...
									<div class="form-group">
										...
										<div class="col-xs-10">
											<input type="text" name="phone" placeholder="Phone" class="form-control" value="<?php echo $this->patient_details[0]->phone; ?>" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-xs-2 control-label" for="phone">Email</label>
										<div class="col-xs-10">
											<input type="email" name="email" placeholder="email" class="form-control" value="<?php echo $this->patient_details[0]->email; ?>" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-xs-2 control-label" for="drpr">Address</label>
										<div class="col-xs-10">
											<input type="text" name="address1" placeholder="Address 1" class="form-control" value="<?php echo $this->patient_details[0]->address1; ?>" />
											<input type="text" name="address2" placeholder="Address 2" class="form-control" value="<?php echo $this->patient_details[0]->address2; ?>" />
											<input type="text" name="address3" placeholder="Address 3" class="form-control" value="<?php echo $this->patient_details[0]->address3; ?>" />
										</div>
									</div>						
									<div class="form-group">
			    					...
			    					<fieldset class="medicalAidDetails">
										...
										<div class="form-group">
											...
											<div class="col-xs-10">
												<input type="text" name="medical_aid_number" placeholder="Medical Aid Number" class="form-control" value="<?php echo $this->patient_details[0]->medical_aid_number; ?>"/>
											</div>
										</div>	
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-xs-10">
												<input type="text" name="member_id" placeholder="Member ID" class="form-control" value="<?php echo $this->patient_details[0]->member_id; ?>"/>
											</div>
										</div>	
										<div class="form-group">
											<label class="col-xs-2 control-label" for="authorisation_code">Authorisation Code</label>
											<div class="col-xs-10">
												<input type="text" name="authorisation_code" placeholder="Authorisation Code" class="form-control" value="<?php echo $this->patient_details[0]->authorisation_code; ?>"/>
											</div>
										</div>	    						
			    					</fieldset>						
									<!-- div class="form-group">
								...
								<div class="patientsEditTarget">
									<div class="modal-body patientsEditDesign">
										...
										<div class="form-group">
											...
											<div class="col-xs-10">
												<input type="text" name="title" placeholder="Title" class="form-control" value="<?php echo $this->patient_details[0]->title; ?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label" for="initials">Initials</label>
											<div class="col-xs-10">
												<input type="text" name="initials" placeholder="Initials" class="form-control" value="<?php echo $this->patient_details[0]->initials; ?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label" for="drpr">Address</label>
										...
										<div class="form-group">
											...
											<div class="col-xs-10">
												<input type="text" name="email" placeholder="Email" class="form-control" value="<?php echo $this->patient_details[0]->email; ?>" />
											</div>
										</div>	
										<div class="form-group">
											...
											<div class="col-xs-10">
												<select name="supress_statement" class="form-control" >
													<option selected ><?php echo $this->patient_details[0]->supress_statement; ?></option>
										...
										<div class="form-group">
											...
											<div class="col-xs-10">
												<select name="account_closed" class="form-control">
													<option selected ><?php echo $this->patient_details[0]->account_closed; ?></option>
													<option value="True" >True</option>
													<option value="False" >False</option>
												</select>						
											</div>
										...
										<div class="form-group">
											...
											<div class="col-xs-10">
												<select name="allow_email_statements" class="form-control" >
													<option selected ><?php echo $this->patient_details[0]->allow_email_statements; ?></option>
													<option value="True" >True</option>
													<option value="False" >False</option>
												</select>								
											</div>
										...
										<div class="form-group">
											...
											<div class="col-xs-10">
												<select name="print_patient_liability" class="form-control" >
													<option selected ><?php echo $this->patient_details[0]->print_patient_liability; ?></option>
													<option value="True" >True</option>
													<option value="False" >False</option>
												</select>									
											</div>
										...
										<div class="form-group">
											<label class="col-xs-2 control-label" for="medical_aid" >Medical Aid</label>
											<div class="col-xs-10">
												<input type="text" name="medical_aid" placeholder="Medical Aid" class="form-control" value="<?php echo $this->patient_details[0]->medical_aid; ?>" />
											</div>
										</div>	
										<div class="form-group">
											<label class="col-xs-2 control-label" for="project_name">Medical Aid Number</label>
										...
										<input type="hidden" name="where" value="patient_id = <?php echo $this->patient_details[0]->patient_id; ?>">
									</div>
								</div>	
								<div class="modal-footer">
									<img src="<?php echo URL;?>public/img/loading.gif" class="loadingImg loader1" >
				...
				<div class="row messagesContainer">
					...
					<div class="messageDesign col-xs-12 col-sm-4 col-md-4 col-lg-3">
						...
						<div class="thumbnail">
							...
							<input type="hidden" value="" class="message_id_holder generic" data-field="patient_message_id" data-set="value" />
			...
			<div class="modal-content">
				...
				<form class="form-horizontal" id="frmAddMessage" role="form" action="<?php echo URL; ?>generic/genericCreate" method="post" enctype="multipart/form-data"  >
					<div class="modal-body">
						...
						<input type="hidden" name="patient_id" value="<?php echo $this->patient_id; ?>" >
						<!-- The genericCreate controller requires you to specify the table you are inserting to -->
						<input type="hidden" name="table" value="<?php echo PREFIX; ?>patient_message" >
					</div>
					<div class="modal-footer">
						<img src="<?php echo URL;?>public/img/loading.gif" class="loadingImg loader1" >
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				...
				<form class="form-horizontal" id="frmEditMessage" role="form" action="<?php echo URL; ?>generic/genericUpdate" method="post" enctype="multipart/form-data"  >
					<div class="editMessageTarget">
						<div class="modal-body messageEditDesign">
							...
							<!-- The genericCreate controller requires you to specify the table you are inserting to -->
							<input type="hidden" name="table" value="<?php echo PREFIX; ?>patient_message" />
							<input type="hidden" name="where" value="patient_message_id = " class="generic" data-field="patient_message_id" data-set="value" />
						</div>
					</div>
					<div class="modal-footer">
						<img src="<?php echo URL;?>public/img/loading.gif" class="loadingImg loader1" >
				...
				<form class="form-horizontal" id="frmAddTransaction" role="form" action="<?php echo URL; ?>generic/genericCreate" method="post" enctype="multipart/form-data"  >
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-10" >
								<select name="patient_id" class="form-control patient_selector" >
									<option value="<?php echo $this->patient_details[0]->patient_id;?>" ><?php echo $this->patient_details[0]->name;?> <?php echo $this->patient_details[0]->surname;?></option>
								</select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-2 control-label" for="phone">ID</label>
							<div class="col-xs-10">
								<input type="text" name="ID" placeholder="ID" class="form-control patient_id_target" value="<?php echo $this->patient_details[0]->id_number;?>" />
							</div>
						</div>												
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-10">
								<input type="text" class="form-control vat_target" placeholder="0.00" disabled />
								<input type="hidden" class="vat_target" name="vat" placeholder="0.00" required />
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-2 control-label" for="cell">Cost Incl Vat</label>
							<div class="col-xs-10">
								<input type="text" class="form-control cost_incl_vat_target"  placeholder="0.00" disabled/>
								<input type="hidden" class="cost_incl_vat_target" name="cost_incl_vat" placeholder="0.00" required />
							</div>
						</div>																		
						<div class="form-group">
							<label class="col-xs-2 control-label" for="gender">Description</label>
				...
				<form class="form-horizontal" id="frmAddSatement" role="form" action="" method="post" enctype="multipart/form-data"  >
					<div class="modal-body">
						...
						<div class="form-group email_container" >
							...
							<div class="col-xs-10">
								<input type="text" id="tbx_email" name="email" placeholder="Message" class="form-control" value="<?php echo $this->patient_details[0]->email; ?>" />
							</div>
						</div>											
						<!-- The genericCreate controller requires you to specify the table you are inserting to -->
						<input type="hidden" name="table" value="<?php echo PREFIX; ?>patient" >
					...
					<div class="modal-footer">
						...
						<input type="hidden" id="patient_id" name="patient_id" value="<?php echo $this->patient_details[0]->patient_id; ?>" >	
						<!--button type="button" class="btn btn-default btn-sm btn_download_statement">Download</button --> 					
						<a href="<?php echo URL; ?>index/pdf_test/<?php echo $this->patient_details[0]->patient_id; ?>/" class="btn btn-default btn-sm tbx_message_target" download >Download</a> 
...
<input type="hidden" id="patient_id" value="<?php echo $this->patient_id; ?>" >
...
<script type="text/javascript" src="<?php echo URL; ?>public/js/use_patient.js"></script>
<script>
...
$('#tbx_message').on("change", function(){
	$('.tbx_message_target').attr("href", $("#URLholder").val()+"index/get_pdf_statement/"+$("#patient_id").val()+"/"+$("#tbx_patient").val()+"/"+$(this).val());
});

$('#tbx_patient').on("change", function(){
	$('.tbx_message_target').attr("href", $("#URLholder").val()+"index/get_pdf_statement/"+$("#patient_id").val()+"/"+$(this).val()+"/"+$("#tbx_message").val());
});
